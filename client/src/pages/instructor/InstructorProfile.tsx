...
// };
  ...
  {loading && (
    <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
      ...
      />
      <Typography variant="body2" sx={{ position: 'absolute', zIndex: 2 }}>
        {`${progress}%`}
      </Typography>
    </div>
  )}
    ...
    />
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
              As an instructor, I am passionate about fostering a positive and engaging learning 
              environment where students can thrive both academically and personally. 
              With a background in Full Stack, I have developed a deep understanding of the material 
              I teach, and I am dedicated to making complex concepts accessible to all learners.
              </p>
            </div>

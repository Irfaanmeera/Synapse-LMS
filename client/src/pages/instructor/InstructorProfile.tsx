        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
            <div className="relative drop-shadow-2">
              <div className="w-auto h-auto rounded-full overflow-hidden">
                <img
                  src={loading ? "/path/to/loading-image.jpg" : user?.image}
                  alt="profile"
              ...
              {loading && (
                <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
                  <LinearProgress
                    variant="determinate"
                    value={progress}
                    sx={{ width: "100%", height: 8, borderRadius: "4px" }}
                  />
                  <Typography
                    variant="body2"
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
                As an instructor, I am passionate about fostering a positive and
                engaging learning environment where students can thrive both
                academically and personally. With a background in Full Stack, I
                have developed a deep understanding of the material I teach, and
                I am dedicated to making complex concepts accessible to all
                learners.
              </p>
            </div>

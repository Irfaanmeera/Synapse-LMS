  ...
  <div className="ml-3">
    ...
    />
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        ...
        <CardDataStats title="Total Revenue" total={`₹ ${Math.floor(user.wallet)}`} rate="4.35%" levelUp>
          <svg
        ...
        <CardDataStats title="Total Courses" total={totalCount} rate="2.59%" levelUp>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="22"
        ...
        <CardDataStats title="Total Enrollments" total={totalEnrolledCount} rate="0.95%" levelDown>
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="18"

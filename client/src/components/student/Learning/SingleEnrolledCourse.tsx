...
import ChatPage from '../../chats/ChatPage'; // Import ChatPage instead of ChatComponent
...
const SingleEnrolledCourse = () => {
  ...
  useEffect(() => {
    ...
    const socketIo = io('http://localhost:4000'); // Replace with your server URL
    setSocket(socketIo);
...
//             <>
//               <h1 className="text-2xl font-medium mb-6">{course?.courseId?.name}</h1>
//               <div className="text-gray">{course?.courseId?.enrolled} Students</div>
//             </>
//           ) : (
//             <ChatComponent
//               courseId={courseId!}
